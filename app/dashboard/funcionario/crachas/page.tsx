        ...
        <main className="min-h-screen bg-black text-white p-8 font-sans print:bg-white print:p-0">
            ...
            <header className="max-w-5xl mx-auto mb-10 flex justify-between items-end print:hidden">
                <div>
                    ...
                    <p className="text-slate-500 text-[10px] uppercase font-bold tracking-[3px] mt-1 italic">Layout Otimizado: 2 Colunas</p>
                </div>
                ...
                {carregando ? (
                    ...
                    funcionarios.map((func) => (
                        ...
                        >
                            ...
                            {/* Código de Barras (Ajustado para não cortar números) */}
                            <div className="absolute bottom-12 left-0 w-full flex flex-col items-center justify-center bg-white px-4">
                                <div className="scale-[1.15] origin-center"> {/* Reduzi o scale para 1.15 */}
                                    <Barcode
                                        value={func.id}
                                        width={1.2}      // Largura da barra ajustada
                                        height={50}     // Altura da barra
                                        fontSize={12}   // Tamanho da fonte dos números
                                        margin={10}     // Margem interna para evitar cortes
                                        background="#ffffff"
                                        lineColor="#000000"
                                    />
                                </div>
