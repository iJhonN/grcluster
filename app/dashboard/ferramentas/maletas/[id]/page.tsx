            ...
            <div className="w-full max-w-4xl mt-4 sm:mt-8 flex flex-col gap-6">
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-[#e5e5ea] pb-8">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 min-w-0 w-full md:w-auto">
                        ...
                        {/* TEXTOS INFORMATIVOS E BOTÃO DE EDITAR */}
                        <div className="min-w-0 py-2">
                            ...
                            <Link
                                href={`/dashboard/ferramentas/maletas/${id}/editar`}
                                className="inline-flex items-center gap-2 mt-3 bg-[#f5f5f7] hover:bg-[#e8e8ed] text-[#1d1d1f] border border-[#e5e5ea] px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider transition-colors shadow-sm"
                            >
                                ✏️ Editar Maleta e Itens
                            </Link>
                        </div>
                    </div>
